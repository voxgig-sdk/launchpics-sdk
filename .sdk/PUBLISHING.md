...
|---|---|---|
| `ts/` | @voxgig-sdk/launchpics-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/launchpics-sdk \
      --repository voxgig-sdk/launchpics-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/launchpics-sdk` shows it, and
`npm trust revoke @voxgig-sdk/launchpics-sdk --id=<id>` removes it.
