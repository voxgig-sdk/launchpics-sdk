...
// Launchpics SDK ratelimit feature
...
class LaunchpicsRatelimitFeature extends LaunchpicsBaseFeature
{
    ...
    private function _acquire(LaunchpicsContext $ctx): void
    {
    ...
    private function _track(LaunchpicsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
