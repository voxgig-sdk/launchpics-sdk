...
// Launchpics SDK streaming feature
...
class LaunchpicsStreamingFeature extends LaunchpicsBaseFeature
{
    ...
    private function _iterate(LaunchpicsResult $result): \Generator
    {
    ...
    private function _streamable(LaunchpicsContext $ctx): bool
    {
