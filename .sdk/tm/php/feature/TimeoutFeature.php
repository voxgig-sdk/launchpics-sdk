...
// Launchpics SDK timeout feature
...
class LaunchpicsTimeoutFeature extends LaunchpicsBaseFeature
{
    ...
    private function _with_timeout(LaunchpicsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LaunchpicsContext $_ctx, float $ms): void
    {
        $client = $this->client;
