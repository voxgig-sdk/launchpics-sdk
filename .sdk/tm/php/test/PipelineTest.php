...
{
    private static function utility(): LaunchpicsUtility
    {
        return new LaunchpicsUtility();
    }
    ...
    private static function ctx(array $over = []): LaunchpicsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new LaunchpicsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new LaunchpicsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof LaunchpicsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new LaunchpicsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = LaunchpicsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new LaunchpicsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = LaunchpicsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new LaunchpicsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = LaunchpicsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LaunchpicsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = LaunchpicsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new LaunchpicsResponse([]),
            'result' => new LaunchpicsResult([]),
        ]);
        [, $err] = LaunchpicsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new LaunchpicsSpec([]),
            'response' => null,
            'result' => new LaunchpicsResult([]),
        ]);
        [, $err] = LaunchpicsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new LaunchpicsSpec(['step' => 's']),
            'response' => new LaunchpicsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new LaunchpicsResult([]),
        ]);
        [, $err] = LaunchpicsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new LaunchpicsSpec(['step' => 's']),
            'response' => new LaunchpicsResponse(self::resp(200, ['v' => 1])),
            'result' => new LaunchpicsResult([]),
        ]);
        [, $err] = LaunchpicsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new LaunchpicsSpec(['step' => 's']),
            'response' => new LaunchpicsResponse(self::resp(200, ['v' => 2])),
            'result' => new LaunchpicsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        LaunchpicsMakeResponse::call($ctx);
    ...
    {
        $preset = new LaunchpicsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new LaunchpicsSpec([]),
            'response' => new LaunchpicsResponse([]),
            'result' => new LaunchpicsResult([]),
        ...
        [$got, $err] = LaunchpicsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new LaunchpicsResult([])]);
        [, $err] = LaunchpicsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new LaunchpicsSpec([]), 'result' => null]);
        [, $err] = LaunchpicsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LaunchpicsSpec(['step' => 's']),
            'result' => new LaunchpicsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new LaunchpicsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LaunchpicsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LaunchpicsSpec(['step' => 's']),
            'result' => new LaunchpicsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new LaunchpicsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LaunchpicsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LaunchpicsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new LaunchpicsSpec([]),
            'result' => new LaunchpicsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = LaunchpicsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LaunchpicsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new LaunchpicsError('boom', 'boom');
        $utility->fetcher = function (LaunchpicsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LaunchpicsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = LaunchpicsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (LaunchpicsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = LaunchpicsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(LaunchpicsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        LaunchpicsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (LaunchpicsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LaunchpicsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = LaunchpicsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new LaunchpicsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new LaunchpicsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = LaunchpicsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = LaunchpicsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = LaunchpicsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new LaunchpicsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, LaunchpicsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new LaunchpicsResult(['ok' => false])]);
        $this->expectException(LaunchpicsError::class);
        LaunchpicsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new LaunchpicsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', LaunchpicsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        LaunchpicsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new LaunchpicsBaseFeature();
        $b = new LaunchpicsBaseFeature();
        LaunchpicsFeatureAdd::call($ctx, $a);
        LaunchpicsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): LaunchpicsBaseFeature
    {
        $f = new LaunchpicsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        LaunchpicsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): LaunchpicsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new LaunchpicsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LaunchpicsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        LaunchpicsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new LaunchpicsResponse(['headers' => null]),
            'result' => new LaunchpicsResult([]),
        ]);
        LaunchpicsResultHeaders::call($ctx);
