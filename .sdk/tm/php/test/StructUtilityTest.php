...
// Launchpics SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = LaunchpicsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(LaunchpicsOmni::structfix($now, Struct::undef()))
                        !== json_encode(LaunchpicsOmni::structfix($val, Struct::undef()))) {
