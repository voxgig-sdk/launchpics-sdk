...
// Launchpics SDK utility: graphql
//
...
class LaunchpicsGraphql
{
    ...
    // equivalent.
    public static function body(LaunchpicsContext $ctx): mixed
    {
    ...
    public static function errors(LaunchpicsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
