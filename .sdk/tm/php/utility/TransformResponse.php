...
// Launchpics SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class LaunchpicsTransformResponse
{
    public static function call(LaunchpicsContext $ctx): mixed
    {
        ...
        $transform = LaunchpicsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
