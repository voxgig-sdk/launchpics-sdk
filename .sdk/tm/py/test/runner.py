...
class LaunchpicsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LaunchpicsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = LaunchpicsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = LaunchpicsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
