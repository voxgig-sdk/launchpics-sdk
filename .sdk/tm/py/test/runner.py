...
class LaunchpicsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LaunchpicsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = LaunchpicsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = LaunchpicsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
