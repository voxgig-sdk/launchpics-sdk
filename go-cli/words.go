...
func registerSDKWords(r *eng.Registry, client *sdk.LaunchpicsSDK) {
...
func runOp(client *sdk.LaunchpicsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
