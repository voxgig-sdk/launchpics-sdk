// Command Launchpics-mcp is an MCP server exposing the Launchpics
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Launchpics_list  — list records of an entity
//	Launchpics_load  — load a single record of an entity
//
