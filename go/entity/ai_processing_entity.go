...
func NewAiProcessingEntity(client *core.LaunchpicsSDK, entopts map[string]any) *AiProcessingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AiProcessingEntity) GetName() string { return e.name }
...
func (e *AiProcessingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AiProcessingEntity) Deleted() bool {
	return e.deleted
}


func (e *AiProcessingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAiProcessingEntity(e.client, opts)
}

func (e *AiProcessingEntity) Data(args ...any) any {
...
func (e *AiProcessingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AiProcessing; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AiProcessingEntity) DataTyped(data ...AiProcessing) AiProcessing {
	if len(data) > 0 {
		return typedFrom[AiProcessing](e.Data(asMap(data[0])))
	}
	return typedFrom[AiProcessing](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AiProcessing (all fields
// optional at the wire level).
func (e *AiProcessingEntity) MatchTyped(match ...AiProcessing) AiProcessing {
	if len(match) > 0 {
		return typedFrom[AiProcessing](e.Match(asMap(match[0])))
	}
	return typedFrom[AiProcessing](e.Match())
}
...
func (e *AiProcessingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AiProcessingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AiProcessingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AiProcessingEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AiProcessingCreateData and returns an AiProcessing. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AiProcessingEntity) CreateTyped(reqdata AiProcessingCreateData, ctrl map[string]any) (AiProcessing, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return AiProcessing{}, err
	}
	return typedFrom[AiProcessing](res), nil
}



func (e *AiProcessingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AiProcessingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AiProcessingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
