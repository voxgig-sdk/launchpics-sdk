...
func NewImageEntity(client *core.LaunchpicsSDK, entopts map[string]any) *ImageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ImageEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// ImageRemoveMatch and returns an Image. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ImageEntity) RemoveTyped(reqmatch ImageRemoveMatch, ctrl map[string]any) (Image, error) {
