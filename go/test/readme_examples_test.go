...
const testSeed = `map[string]any{"entity": map[string]any{"ai_processing": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "health": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "image": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
