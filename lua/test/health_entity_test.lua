...
describe("HealthEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set LAUNCHPICS_TEST_HEALTH_ENTID JSON to run live")
      return
    end
...
function health_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("LAUNCHPICS_TEST_HEALTH_ENTID")
