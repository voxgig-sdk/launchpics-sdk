...
class ImageEntity
{
     ...
     *
     * @param ImageRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ImageRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Image|array The removed Image as an assoc-array at the
     *   SDK boundary; throws LaunchpicsError on failure (item-5 convention).
     */
