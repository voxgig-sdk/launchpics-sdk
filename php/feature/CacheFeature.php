...
class LaunchpicsCacheFeature extends LaunchpicsBaseFeature
{
    ...
    private function _through(LaunchpicsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
