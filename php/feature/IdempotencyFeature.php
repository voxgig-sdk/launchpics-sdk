...
// Launchpics SDK idempotency feature
...
class LaunchpicsIdempotencyFeature extends LaunchpicsBaseFeature
{
    ...
    private function _mutating(LaunchpicsContext $ctx): bool
    {
