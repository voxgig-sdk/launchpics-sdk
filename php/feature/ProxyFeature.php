...
class LaunchpicsProxyFeature extends LaunchpicsBaseFeature
{
    ...
    public function init(LaunchpicsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LaunchpicsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
