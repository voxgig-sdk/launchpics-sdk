...
class LaunchpicsRbacFeature extends LaunchpicsBaseFeature
{
    ...
    private function _required(LaunchpicsContext $ctx): ?string
    {
    ...
    private function _reject(LaunchpicsContext $ctx, string $required): void
    {
    ...
    private function _track(LaunchpicsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
