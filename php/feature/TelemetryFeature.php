...
// Launchpics SDK telemetry feature
...
class LaunchpicsTelemetryFeature extends LaunchpicsBaseFeature
{
    ...
    private function _close(LaunchpicsContext $ctx, bool $ok): void
    {
