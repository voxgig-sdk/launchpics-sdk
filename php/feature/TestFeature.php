...
// Launchpics SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class LaunchpicsTestFeature extends LaunchpicsBaseFeature
{
    ...
    public function init(LaunchpicsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (LaunchpicsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = LaunchpicsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (LaunchpicsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(LaunchpicsContext $ctx, $op, $args): array
    {
