...
// Launchpics SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LaunchpicsSDK::test)
...
{
    private const SDK_CLASS = 'LaunchpicsSDK';
    ...
    private const SDK_BASE = 'launchpics_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../launchpics_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
