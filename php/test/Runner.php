...
class LaunchpicsTestRunner
{
    ...
    {
        $live = self::getenv('LAUNCHPICS_TEST_LIVE');
        $override = self::getenv('LAUNCHPICS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('LAUNCHPICS_TEST_EXPLAIN');
...
class_alias('LaunchpicsTestRunner', 'Runner');
class_alias('LaunchpicsHelpers', 'Helpers');
