...
// Launchpics SDK utility: fetcher

class LaunchpicsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LaunchpicsSDK/1.0)';
    ...
    public static function call(LaunchpicsContext $ctx, string $fullurl, array $fetchdef): array
    {
