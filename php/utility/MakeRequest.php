...
// Launchpics SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class LaunchpicsMakeRequest
{
    public static function call(LaunchpicsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new LaunchpicsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new LaunchpicsResponse($fetched);
        } else {
