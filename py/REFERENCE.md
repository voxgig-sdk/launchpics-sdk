# Launchpics Python SDK Reference

Complete API reference for the Launchpics Python SDK.
...
#### `LaunchpicsSDK.test(testopts=None, sdkopts=None)`
...
#### `AiProcessing(data=None)`

Create a new `AiProcessingEntity` instance. Pass `None` for no initial data.
...
Create a new `AiProcessingEntity` instance with the same options.
