...
from launchpics_sdk.core.control import LaunchpicsControl
...
from launchpics_sdk.core.helpers import get_ctx_prop, to_map
...
class LaunchpicsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, LaunchpicsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, LaunchpicsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, LaunchpicsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return LaunchpicsError(code, msg, self)
