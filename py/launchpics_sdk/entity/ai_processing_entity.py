...
from launchpics_sdk.launchpics_types import (
    AiProcessing,
...
class AiProcessingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AiProcessingEntity(self._client, opts)
    ...
    def data_get(self) -> AiProcessing:
    ...
    def match_get(self) -> AiProcessing:
    ...
    def create(self, reqdata: AiProcessingCreateData, ctrl=None) -> AiProcessing:
        utility = self._utility
