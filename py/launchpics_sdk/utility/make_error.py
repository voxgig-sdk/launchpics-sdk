# Launchpics SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, LaunchpicsError):
        errmsg = err.msg
    ...
    msg = "LaunchpicsSDK: " + opname + ": " + errmsg
    ...
    sdk_err = LaunchpicsError("", msg, ctx)
