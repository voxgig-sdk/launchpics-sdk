...
from launchpics_sdk.core.spec import LaunchpicsSpec
from launchpics_sdk.core.result import LaunchpicsResult
from launchpics_sdk.core.response import LaunchpicsResponse
from launchpics_sdk.core.operation import LaunchpicsOperation
from launchpics_sdk.core.error import LaunchpicsError
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return LaunchpicsError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = LaunchpicsSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = LaunchpicsSDK.test(None, None)
        ...
        class TestInitFeature(LaunchpicsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(LaunchpicsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = LaunchpicsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = LaunchpicsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = LaunchpicsSDK.test(None, setup_opts)
