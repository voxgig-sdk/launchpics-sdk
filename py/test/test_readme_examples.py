# Launchpics SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LaunchpicsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LaunchpicsSDK(...) and LaunchpicsSDK.test(...) become
#      LaunchpicsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "launchpics_sdk"
_SDK_CLASS = "LaunchpicsSDK"
