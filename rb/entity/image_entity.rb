...
class ImageEntity
  ...
  # @return [Image, Hash] the loaded Image; raises LaunchpicsError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Image, Hash] the created Image; raises LaunchpicsError on failure
  ...
  # Remove an Image matching the given criteria.
  #
  # @param reqmatch [ImageRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Image, Hash] the removed Image; raises LaunchpicsError on failure
