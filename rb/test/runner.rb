...
module LaunchpicsTestRunner
  ...
  def self.env_override(m)
    live = getenv("LAUNCHPICS_TEST_LIVE")
    override = getenv("LAUNCHPICS_TEST_OVERRIDE")
    ...
    explain = getenv("LAUNCHPICS_TEST_EXPLAIN")
    m["LAUNCHPICS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = LaunchpicsTestRunner
Helpers = LaunchpicsHelpers
Vs = VoxgigStruct
