...
(0, node_test_1.describe)('AiProcessingEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != ai_processing_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/ai_processing/AiProcessingTestData.json');
    ...
    let idmap = transform(['ai_processing01', 'ai_processing02', 'ai_processing03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AiProcessingEntity.test.js.map