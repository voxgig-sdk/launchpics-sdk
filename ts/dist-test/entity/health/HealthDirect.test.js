...
(0, node_test_1.describe)('HealthDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.LaunchpicsSDK({
...
function liveScenariosActive() { return false && process.env.LAUNCHPICS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'LAUNCHPICS_TEST_HEALTH_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.LaunchpicsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.LAUNCHPICS_APIKEY,
        }));
        let idmap = env['LAUNCHPICS_TEST_HEALTH_ENTID'];
    ...
    const client = new __1.LaunchpicsSDK({
        base: 'http://localhost:8080',
