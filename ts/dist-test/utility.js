...
function envOverride(m) {
    if ('TRUE' === process.env.LAUNCHPICS_TEST_LIVE ||
        'TRUE' === process.env.LAUNCHPICS_TEST_OVERRIDE) {
    ...
    m.LAUNCHPICS_TEST_EXPLAIN = process.env.LAUNCHPICS_TEST_EXPLAIN || m.LAUNCHPICS_TEST_EXPLAIN;
    return m;
}
