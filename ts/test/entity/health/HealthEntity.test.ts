...
function basicSetup(extra?: any) {
  ...
  idmap = env['LAUNCHPICS_TEST_HEALTH_ENTID']

  const live = 'TRUE' === env.LAUNCHPICS_TEST_LIVE

  const transport = createLiveTransport()
  if (live) {
    const rawIds = process.env['LAUNCHPICS_TEST_HEALTH_ENTID']
